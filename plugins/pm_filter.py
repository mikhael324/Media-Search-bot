...
async def filter(client, message):
    ...
    if AUTH_CHANNEL:
        ...
        try:
            ...
            await client.send_message(
                chat_id=message.from_user.id,
                text="**Please Join My Movie Updates Channel To Use Me  \n \n എന്നെ ഉപയോഗിക്കണമെങ്കിൽ Movie Updates Channel ഫോളോ ചെയ്യുക👇**",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🔔 Movie Updates Channel 🔔", url=invite_link.invite_link)
                        ]
                    ]
                ),
                parse_mode="markdown"
    ...
    if 2 < len(message.text) < 100:    
        ...
        if files:
            ...
            await client.send_message(chat_id=message.from_user.id, text="Check Your Spelling 😅", parse_mode="markdown", disable_web_page_preview=True)
            return 
        ...
        if len(btn) > 10: 
            ...
            if poster:
                ...
                await k.edit_text(f"<b>🗑️ Filter For {search} Is Closed ‼️</b>")
